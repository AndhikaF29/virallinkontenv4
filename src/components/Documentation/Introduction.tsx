      ...
      <div id="version" className="md:scroll-m-[180px] scroll-m-28">
        ...
        <div className="mt-5">
          <p className="text-base font-medium text-muted text-opacity-60">
            Template Crypgo Tailwind NextJs dikembangkan oleh Andhika Fajar
            Prayoga dan Hilmi Musyadad dari virallinkonten.com
          </p>
          <p className="text-base font-medium text-muted text-opacity-60">
            Template ini siap digunakan dan dapat dikustomisasi sesuai kebutuhan
            Anda.
          </p>
          <p className="text-base font-medium text-muted text-opacity-60">
            Untuk kustomisasi, Anda perlu memiliki pengetahuan tentang NextJs,
            ReactJs, Tailwind dan JSX.
          </p>
          <p className="text-base font-medium text-muted text-opacity-60">
            Kontak: Viralinagency01@gmail.com | +62 858‑6138‑4907 | Bandung,
            Jawa Barat
          </p>
        </div>
      </div>
